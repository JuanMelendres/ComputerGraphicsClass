...
function init()
{
	...
	var txCamera = 0.5;
	var tyCamera = 0.5;
	mat4.translate(viewMatrix, viewMatrix, [-txCamera, -tyCamera, 0]);
	...
	// Uniforms
	var uModelMatrixLocation = gl.getUniformLocation(shaderProgram, "uModelViewMatrix");
	gl.uniformMatrix4fv(uModelMatrixLocation, false, modelViewMatrix);
