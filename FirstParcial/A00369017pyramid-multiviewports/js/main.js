...
function render(currentTime)
{
	...
	if (multiViewPort) {
		gl.viewport(canvas.height/2,canvas.height/2,canvas.width/2,canvas.height/2) // 2
...
//---------------------------------------------------------------------------------------
		...
		var eyeY1 = 1;
		eyeX = eyeZo * Math.cos(tetha);
		eyeZ = eyeZo * Math.sin(tetha);
		...
		mat4.lookAt(viewMatrix, [eyeX, eyeY1, eyeZ], [centerX, centerY, centerZ], [upX, upY, upZ]);
	...
	//---------------------------------------------------------------------------------------
		...
		upX1 = upXo* Math.sin(tetha);
		var upY = 0.;
		upZ1= upXo * Math.cos(tetha);

		mat4.lookAt(viewMatrix, [eyeX2, eyeY2, eyeZ2], [centerX, centerY, centerZ], [upX1, upY, upZ1]);
	...
	//-----------------------------------------------------------------------------------------
		...
		gl.viewport(0,0,canvas.height/2,canvas.height/2)
